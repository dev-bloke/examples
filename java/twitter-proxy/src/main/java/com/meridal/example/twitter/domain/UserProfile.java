...
public class UserProfile extends User {
	...
	public String toCSV() {
		...
		this.appendField(builder,"Name", this.getName());
		this.appendField(builder,"Location", this.getLocation());
		this.appendField(builder,"Description", this.getDescription());
	...
	private void appendField(final StringBuilder builder, final String listName, final List<UserProfile> users) {
		if (users != null && !users.isEmpty()) {
			...
			for (final UserProfile user : users) {
				...
				builder.append(this.escapeSpecialCharacters(user.getName())).append(",");
				builder.append(this.escapeSpecialCharacters(user.getLocation())).append(",");
				builder.append(this.escapeSpecialCharacters(user.getDescription())).append(",");
				...
				builder.append(this.countAsString(user.getTweets())).append(",");
				builder.append(this.escapeSpecialCharacters(user.getDescription())).append(NEWLINE);
			}
		}
	}
