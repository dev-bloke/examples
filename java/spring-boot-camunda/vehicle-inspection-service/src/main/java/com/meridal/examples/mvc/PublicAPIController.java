...
import com.meridal.examples.service.InspectionService;
...
public class PublicAPIController {
	...
	@RequestMapping(value="/inspection/all", method=RequestMethod.GET)
	@ResponseBody	
	public List<VehicleCertificate> getAllVehicleCertificates() {
		return this.inspectionService.findAllVehicleCertificates();
	}

	@RequestMapping(value="/inspection/{registrationNumber}", method=RequestMethod.GET)
	@ResponseBody	
	...
	@RequestMapping(value="/inspection/{registrationNumber}", method=RequestMethod.PUT)
	@ResponseBody
	...
	@RequestMapping(value="/inspection", method=RequestMethod.DELETE)
	@ResponseBody
